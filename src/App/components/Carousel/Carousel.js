...
class Carousel extends Component {
  ...
  constructor(props) {
    ...
    this.interval = null;
    this.resizeEventListenerThrottle = 300;
    this.clickDragThreshold = 10;
    this.numberOfInfiniteClones = 3;
  }
  ...
  getClonesLeft = () =>
    this.numberOfInfiniteClones + this.getAdditionalClonesLeft();
  getClonesRight = () =>
    this.numberOfInfiniteClones + this.getAdditionalClonesRight();
  ...
  }, this.resizeEventListenerThrottle);
  ...
  onMouseUpTouchEnd = (e) => {
    if (this.state.dragStart !== null) {
      ...
      if (
        ...
        Math.abs(this.state.dragOffset) > this.clickDragThreshold
      ) {
  ...
  renderCarouselItems = () => {
    ...
    return (
      <div className={styles.carouselTrackContainer}>
        <ul
          className={cx(styles.carouselTrack, {
  ...
  renderArrowWithAddedHandler = (element, onClick, name, disable = false) => (
    <div
      className={cx(
        ...
        {
          carouselArrowDisabled: disable,
        },
        styles[`carouselArrow-${name}`]
      )}
  ...
  render() {
    return (
      <div
        className={cx(styles.carousel, this.getProp('className'))}
        ref={(el) => (this.node = el)}
      >
